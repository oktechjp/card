    ...
    <>
      <section>
        ...
        <p>
          ...
          template.
          <img src="/public/screenshot-06-create-new-template.png" />
        </p>
        <p>
          Use the normal settings
          <img src="/public/screenshot-07-size-choices.png" />
        </p>
        <p>
          Upload the front and back side of the card.
          <img src="/public/screenshot-08-upload.png" />
        </p>
        <p>
          Drag & Drop the front side on the editor and use the "配置" button to
          change the positon. Set it to 96x60 at -2.5/-2.5.
          <img src="/public/screenshot-09-positioning.png" />
        </p>
        <p>
          Add a page then do the same thing with the background image.
          <img src="/public/screenshot-10-add-bg.png" />
        </p>
        <p>
        ...
        <p>
          ...
          <img src="/public/screenshot-02-add-to-cart.png" />
          <img src="/public/screenshot-03-selection.png" />
        </p>
        <p>
          To upload the designs use the{" "}
          <img src="/public/screenshot-04-upload-data.png" /> and{" "}
          <img src="/public/screenshot-05-select-mydesign.png" /> to add our
          designs.
        </p>
        <p>
          Use <strong>both</strong> template files you just created.
          <img src="/public/screenshot-06-use-sides.png" />
        </p>
        <p>
          Follow through the data check.
          <img src="/public/screenshot-11-data-check.png" />
        </p>
