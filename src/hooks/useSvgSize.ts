...
export function getStyleNum(map: CSSStyleDeclaration, name: keyof CSSStyleDeclaration): number | undefined {
    const prop = map[name]
...
export function getStyleKw<props extends string[]>(styleMap: CSSStyleDeclaration, name: keyof CSSStyleDeclaration, options: props, standard: string): props[number] | undefined {
